...
function Tetris(opts){
	...
	var init = (function(){
        ...
        _self.plineCanvas = plineCanvas;
        _self.plineCtx = plineCtx;
		...
		stageElm.append(stageHTML.join(''));
...
Tetris.prototype.draw = function(){
 //   console.log('draw');
    ...
    var plineCtx = _self.plineCtx;
    var plineCanvas = _self.plineCanvas;
...
//
    ...
    for(var i=0; i<metrixLen; i++){
        ...
        if(color){
            ...
            plineCtx.fillStyle = color;
            plineCtx.fillRect(x, y, _self.blockWidth-2, _self.blockWidth-2);
            //stop condition
